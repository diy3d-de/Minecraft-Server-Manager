...
namespace Minecraft_Server_Manager
{
    public partial class Form1 : Form
    {
        ...
        string players2 = "";
        bool serverRunning;
        bool startServerAfterBackup = false;
        ...
        public void AddTextToOutputTextBox(string strText)
        {
            ...
            try
            {
                ...
                if (blah.Contains("Version"))
                {
                    ...
                    lblRunningServerVersion.Text = "Running: " + thisVersion;
                }
        ...
        private void backgroundWorker1_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            ...
            startServerButton.Enabled = false;
            stopServerButton.Enabled = false;
            lblServerRunningStatus.Text = "backing up your world(s) ...";
            lblServerRunningStatus.BackColor = System.Drawing.Color.Orange;

            startServerAfterBackup = false;

            if (serverRunning == true)
            {
                startServerAfterBackup = true;
            ...
            if (startServerAfterBackup == true)
            {
